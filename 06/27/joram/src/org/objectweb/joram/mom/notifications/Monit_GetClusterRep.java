...
/**
 * A <code>Monit_GetClusterRep</code> reply is used by a topic for sending
...
public class Monit_GetClusterRep extends AdminReply
{
  ...
  /**
   * Constructs a <code>Monit_GetClusterRep</code> instance.
   *
   * @param request  The request this reply replies to.
   * @param topics  Topics identifiers.
   */
  public Monit_GetClusterRep(AdminRequest request, Vector topics)
  {
