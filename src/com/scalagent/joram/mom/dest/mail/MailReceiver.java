...
public interface MailReceiver {
   ...
   * 
   * @param period
   *          The period value to collect mail or -1 for unsetting previous
   *          value.
   */
   ...
   * 
   * @param server
   *          The pop server or null for unsetting previous value.
   */
   ...
   * 
   * @param user
   *          The username for pop account or null for unsetting previous value.
   */
   ...
   * 
   * @param pass
   *          The password for pop account or null for unsetting previous value.
   */
   ...
   * 
   * @param expunge
   *          The default <code>expunge</code> field or null for unsetting
   *          previous value.
   */
