...
if ($MESSAGE eq "") {
  ...
  print "<ol>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.1-src.tar.gz\">sources (tar.gz file)</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.1-src.zip\">sources(zip file)</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.1-bin.tar.gz\">jars (tar.gz file)</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.1-bin.zip\">jars (zip file)</a></li>\n";
  print "</ol>\n";
  print "</li>\n";
  print "</ul>";
