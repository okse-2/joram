...
public class SelectorTest extends PTPTestCase {
  ...
  /**
   * Test that an empty string as a message selector indicates that there is no
   ...
   * <ul>
   * <li><code>"string = 'literal''s;"</code> is <code>true</code> for
   * "literal's" and <code>false</code> for "literal"</li>
   * </ul>
   */
   ...
   * having the values <code>'PERSISTENT'</code> or
   * <code>'NON_PERSISTENT'</code> when used in a message selector (chapter
   * 3.8.1.3).
   */
  public void testJMSDeliveryModeInSelector() {
    try {
      ...
      sender.send(dummyMessage, DeliveryMode.NON_PERSISTENT, sender
          .getPriority(), sender.getTimeToLive());
  ...
  /**
   * Test that conversions that apply to the <code>get</code> methods for
   * properties do not apply when a property is used in a message selector
   * expression. Based on the example of chapter 3.8.1.1 about identifiers.
   */
  ...
  /**
   * Test the message selector using the filter example provided by the JMS
   * specifications. <br />
   * <ul>
   ...
   * <ul>
   * <li><code>"weight > 2500"</code> is <code>true</code> for 3000 and
   * <code>false</code> for 1000</li>
   * </ul>
   */
   ...
   * Test the "=" condition in message selector. <br />
   * <ul>
   * <li><code>"weight > 2500"</code> is <code>true</code> for 2500 and
   * <code>false</code> for 1000</li>
   * </ul>
   */
   ...
   * <ul>
   * <li><code>"weight <> 2500"</code> is <code>true</code> for 1000 and
   * <code>false</code> for 2500</li>
   * </ul>
   */
  public void testNotEquals() {
    try {
      ...
      receiver = receiverSession
          .createReceiver(receiverQueue, "weight <> 2500");
      receiverConnection.start();
   ...
   * <ul>
   * <li>"age BETWEEN 15 and 19" is <code>true</code> for 17 and
   * <code>false</code> for 20</li>
   * </ul>
   */
  public void testBetween() {
    try {
      ...
      assertTrue("Message of another test: " + msg.getText(), msg.getText()
          .startsWith("testBetween"));
   ...
   * <ul>
   * <li>"Country IN ('UK', 'US', 'France')" is <code>true</code> for 'UK'
   * and <code>false</code> for 'Peru'</li>
   * </ul>
   */
  public void testIn() {
    try {
   ...
   * <ul>
   * <li>"underscored LIKE '\_%' ESCAPE '\'" is <code>true</code> for '_foo'
   * and <code>false</code> for 'bar'</li>
   * </ul>
   */
   ...
   * <ul>
   * <li>"word LIKE 'l_se'" is <code>true</code> for 'lose' and
   * <code>false</code> for 'loose'</li>
   * </ul>
   */
   ...
   * <ul>
   * <li>"phone LIKE '12%3'" is <code>true</code> for '12993' and
   * <code>false</code> for '1234'</li>
   * </ul>
   */
