...
/**
 * Test the PooledConnectionFactory with various users.
 */
public class Test3 extends TestCase {
  ...
  public void run() {
    try {
      ...
      assertFalse("Connexion #2 for anonymous2 is same than anonymous", (cnx1 == cnx2));      
      ...
      assertTrue("Connexion #3 for anonymous is new", (cnx1 == cnx3));
      cnx3.close();
      
      Connection cnx4 = pcf.createConnection("anonymous2", "anonymous2");
      System.out.println("cnx4=" + cnx4);
      assertTrue("Connexion #4 for anonymous2 is new", (cnx2 == cnx4));
      cnx4.close();
      
      Connection cnx5 = null;
      Exception jmsexc = null;
      try {
        cnx5 = pcf.createConnection("anonymous", "toto");
      } catch (JMSException exc) {
        jmsexc = exc;
      }
      assertTrue("Connection #5 should be null: " + cnx5, (cnx5 == null));
      assertTrue("Bad exception for Connection #5: " + jmsexc, (jmsexc instanceof JMSSecurityException));
    } catch (Throwable exc) {
      exc.printStackTrace();
      error(exc);
    } finally {
