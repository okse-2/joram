...
public class ReadOnlyMessageMOMExtern extends MessageMOMExtern { 
	...
	public ReadOnlyMessageMOMExtern(long requestID, fr.dyade.aaa.mom.QueueNaming queue, String selector) {
		super(requestID);
