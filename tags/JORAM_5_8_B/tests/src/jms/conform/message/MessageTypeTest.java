 ...
 * <li><code>MapMessage</code> with name-value pairs of Java primitives in
 * its body</li>
 * <li><code>StreamMessage</code> with a stream of Java primitives as body</li>
 * </ol>
 * <br />
 * For each of this type of message, we test that a message can be sent and
 * received with an empty body or not.
 */
public class MessageTypeTest extends PTPTestCase {

  /**
   * Send a <code>StreamMessage</code> with 2 Java primitives in its body (a
   * <code>
   * String</code> and a <code>double</code>). <br />
   * Receive it and test that the values of the primitives of the body are
   * correct
   */
  ...
  /**
   * Test in MapMessage the conversion between <code>getObject("foo")</code>
   * and <code>getDouble("foo")</code> (the later returning a java.lang.Double
   * and the former a double)
   */
   ...
   * <code>MapMessage</code> is <code>null</code>, the method must throw
   * the error <code>java.lang.IllegalArgumentException</code>. <br />
   * 
   * @since JMS 1.1
   */
  ...
  /**
   * Test that the if the name parameter of the set methods of a
   * <code>MapMessage</code> is an empty String, the method must throw the
   * error <code>java.lang.IllegalArgumentException</code>. <br />
   * 
   * @since JMS 1.1
   */
  ...
  /**
   * Send a <code>MapMessage</code> with 2 Java primitives in its body (a
   * <code>
   * String</code> and a <code>double</code>). <br />
   * Receive it and test that the values of the primitives of the body are
   * correct
  ...
  /**
   * Send an <code>ObjectMessage</code> with a <code>Vector</code> (composed
   * of a <code>
  ...
  /**
   * Send a <code>BytesMessage</code> with 2 Java primitives in its body (a
   * <code>
   * String</code> and a <code>double</code>). <br />
   * Receive it and test that the values of the primitives of the body are
   * correct
