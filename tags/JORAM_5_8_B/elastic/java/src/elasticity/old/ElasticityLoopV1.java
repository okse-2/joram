 ...
 *
 */
public class ElasticityLoopV1 {

	/** Logger object. */
	private final static Logger logger = Logger.getLogger(ElasticityLoopV1.class.getName());

	/** Log file. */
	private final static String loggerFile = ElasticityLoopV1.class.getName() + ".log"; 

	/** Limit over which we add new workers. */
	public static final int maxCapThreshold = 100;
