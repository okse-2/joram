...
/**
 * Test :
 *     The text message received by the consumer is the same that 
 *     the text message sent by the producer 
 *     Use a Queue
 */
public class Test_Q_MText extends TestCase {

   
    public static void main(String[] args) {
	new Test_Q_MText().run();
    }
