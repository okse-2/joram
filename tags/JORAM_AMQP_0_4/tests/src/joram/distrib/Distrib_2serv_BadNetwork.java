 ...
 * server 0. The consumer is attached to server 1. The queue is created on
 * server 0.
 */
public class Distrib_2serv_BadNetwork extends TestCase {
  ...
  public static void main(String args[]) {
    new Distrib_2serv_BadNetwork().run();
  }
