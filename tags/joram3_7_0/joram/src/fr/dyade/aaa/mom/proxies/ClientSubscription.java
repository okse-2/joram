...
import fr.dyade.aaa.mom.comm.ClientMessages;
import fr.dyade.aaa.mom.dest.DeadMQueueImpl;
import fr.dyade.aaa.mom.jms.ConsumerMessages;
...
class ClientSubscription implements java.io.Serializable
{
   ...
   */
  void reinitialize(PersistenceModule persistenceModule,
                    Hashtable messagesTable,
