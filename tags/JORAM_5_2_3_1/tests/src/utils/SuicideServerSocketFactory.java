 ...
 */
public class SuicideServerSocketFactory extends ServerSocketFactory {
  /**
  ...
  public static ServerSocketFactory getFactory() {
    if (factory == null)
      factory = new SuicideServerSocketFactory();
    return factory;
  }
  ...
  public ServerSocket createServerSocket(int port, int backlog) throws IOException {
    return new SuicideServerSocket(port, backlog);
  }
  ...
  public ServerSocket createServerSocket(int port,
    ...
    return new SuicideServerSocket(port, backlog, addr);
  }
}
