             ...
             extends fr.dyade.aaa.joram.XAConnectionFactory
{
  ...
  /**
   * Codes an <code>XATcpConnectionFactory</code> as a vector for travelling
  ...
  public Vector code() throws NamingException
  {
    ...
    vec.add("XATcpConnectionFactory");
  ...
  /**
   * Decodes a coded <code>XATcpConnectionFactory</code>.
   *
                ...
                throws NamingException
  {
    try {
      ...
      XATcpConnectionFactory cnxFact = new XATcpConnectionFactory(host, port);
