...
public class AckQueueMessageMOMExtern extends MessageMOMExtern { 
	...
	public AckQueueMessageMOMExtern(long requestID, fr.dyade.aaa.mom.QueueNaming queue, java.lang.String messageID, int ackMode, java.lang.String sessionID) {
		super(requestID);
		this.queue = queue;
