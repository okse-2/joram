 ...
 */
public class A3CMLPServer extends A3CMLServer{
  public Vector networks = null;
  public boolean visited = false;
  /**
   * Server Id. of router (1st hop) used to access this domain from current
   * node, if -1 the domain is directly accessible.
   */
