...
/**
 * Notification requesting a name-agent unregistration.
...
public static final String RCS_VERSION="@(#)$Id: UnregisterCommand.java,v 1.12 2004-02-13 08:14:35 fmaistre Exp $";
   ...
   */
  public UnregisterCommand(AgentId report, String name) {
    super(report, name);
  }
}
