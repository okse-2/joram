...
set CLASSPATH=%JORAM_BUNDLES%\joram-client.jar
set CLASSPATH=%CLASSPATH%;%JORAM_BUNDLES%\joram-shared.jar
set CLASSPATH=%CLASSPATH%;%JORAM_BUNDLES%\joram-common-util.jar
set CLASSPATH=%CLASSPATH%;%JORAM_BUNDLES%\JCup.jar
set CLASSPATH=%CLASSPATH%;%JORAM_BUNDLES%\geronimo-jms_1.1_spec-1.1.1.jar
set CLASSPATH=%CLASSPATH%;%JORAM_BUNDLES%\ow_monolog.jar
