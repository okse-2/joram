 ...
 *     &lt;property name="path"&gt;/the_path&lt;/property&gt;
 *     
 ...
 *
 */
public class ServiceFtpQueue extends ServiceDestination implements ManagedServiceFactory {
	public static final Logger logmon = Debug.getLogger(ServiceFtpQueue.class.getName());
	public static final String PID_NAME = "joram.ftpqueue";
	
  private ServiceRegistration registration;
  private String className = Queue.FTP_QUEUE;
  
  public ServiceFtpQueue(final BundleContext bundleContext) {
    super(bundleContext);
  	if (logmon.isLoggable(BasicLevel.DEBUG))
      logmon.log(BasicLevel.DEBUG, "ServiceFtpQueue(" + bundleContext + ')');
  ...
  throws ConfigurationException {
  	if (logmon.isLoggable(BasicLevel.DEBUG))
  		logmon.log(BasicLevel.DEBUG, "ServiceFtpQueue.updated(" + pid + ", " + properties + ')');
  	...
  	try {
  		...
  		if (logmon.isLoggable(BasicLevel.ERROR))
	  		logmon.log(BasicLevel.ERROR, "ServiceFtpQueue.updated ", e);
	...
	public void deleted(String pid) {
		if (logmon.isLoggable(BasicLevel.DEBUG))
      logmon.log(BasicLevel.DEBUG, "ServiceFtpQueue.deleted(" + pid + ')');
		super.deleted(pid);
  }
}