 ...
 * Testing:
 *
 * - Add interceptor on Queue creation.
 ...
 */
public class Test_Q6 extends TestCase {
  ...
  public void run() {
    try {
      ...
      // add interceptor
      queue.addInterceptors("joram.interceptors.Exit4");
      
      // get interceptors
      assertEquals("joram.interceptors.Exit1,joram.interceptors.Exit4", queue.getInterceptors());
      
      // replace interceptor
      queue.replaceInterceptor("joram.interceptors.Exit2", "joram.interceptors.Exit1");
      ...
      // get interceptors
      assertEquals("joram.interceptors.Exit2,joram.interceptors.Exit4", queue.getInterceptors());
      ...
      // remove interceptors
      queue.removeInterceptors("joram.interceptors.Exit2");
