...
/** 
 *	this Exception is thrown in the MOM when the agent is unknown
 * 
 *	@see	fr.dyade.aaa.mom.MessageMOMExtern 
 */ 
 
public class ExceptionUnknownObjMOMExtern extends ExceptionMessageMOMExtern { 
	
	/** the name of the agent which is incorrect */
