...
CLASSPATH=$JORAM_BUNDLES/joram-client.jar
CLASSPATH=$CLASSPATH:$JORAM_BUNDLES/joram-mom.jar
CLASSPATH=$CLASSPATH:$JORAM_BUNDLES/joram-shared.jar
CLASSPATH=$CLASSPATH:$JORAM_BUNDLES/JCup.jar
CLASSPATH=$CLASSPATH:$JORAM_BUNDLES/geronimo-jms_1.1_spec-1.1.1.jar
CLASSPATH=$CLASSPATH:$JORAM_BUNDLES/ow_monolog.jar
