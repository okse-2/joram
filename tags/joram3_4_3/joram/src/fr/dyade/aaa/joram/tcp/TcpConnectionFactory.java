...
public class TcpConnectionFactory extends fr.dyade.aaa.joram.ConnectionFactory
{
  ...
  /**
   * Codes a <code>TcpConnectionFactory</code> as a vector for travelling
  ...
  /**
   * Decodes a coded <code>TcpConnectionFactory</code>.
   *
                ...
                throws NamingException
  {
    try {
      ...
      TcpConnectionFactory cnxFact = new TcpConnectionFactory(host, port);
