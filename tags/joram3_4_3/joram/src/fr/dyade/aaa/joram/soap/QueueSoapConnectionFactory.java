             ...
             extends fr.dyade.aaa.joram.QueueConnectionFactory
{
  ...
  /**
   * Codes a <code>QueueSoapConnectionFactory</code> as a vector for travelling
  ...
  public Vector code() throws NamingException
  {
    ...
    vec.add("QueueSoapConnectionFactory");
  ...
  /**
   * Decodes a coded <code>QueueSoapConnectionFactory</code>.
   *
                ...
                throws NamingException
  {
    try {
      ...
      QueueSoapConnectionFactory cnxFact =
        new QueueSoapConnectionFactory(host, port, timeout);
