...
// AF: TODO wa should handle the 'shared' message and use the converter
// methods from 'joram' message
...
//       // DF: comment this code because it is not compatible with typed
//       // destinations
...
//       else if (momMessage.getType() == MessageType.SIMPLE)
//         jmsMessage = jmsSession.createMessage();
    }
...
// AF: TODO
      // Setting the Type field.
      if (momMessage.msg.getOptionalHeader("JMSType") != null)
        jmsMessage.setJMSType((String) momMessage.msg.getOptionalHeader("JMSType"));
...
//            names.hasMoreElements();) { 
//         name = (String) names.nextElement();
//         jmsMessage.setObjectProperty(name, momMessage.getProperty(name));
//       }
    } catch (JMSException exc) {
