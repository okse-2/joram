...
import org.objectweb.joram.client.jms.ha.tcp.*;
...
public class HATest2 extends TestCase {
	...
	try {
	    ...
	    TopicConnectionFactory cf = TopicHATcpConnectionFactory.create("hajoram://localhost:2560,localhost:2561,localhost:2562");
