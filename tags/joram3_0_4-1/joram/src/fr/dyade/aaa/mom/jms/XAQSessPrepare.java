...
/**
 * An <code>XAQSessPrepare</code> instance is used by an
 * <code>XAQueueSession</code> for sending messages and acknowledgements
 * to the proxy.
 */
public class XAQSessPrepare extends AbstractJmsRequest
{
  ...
  /** Vector of <code>QSessAckRequest</code> instances. */
  private Vector acks;
  

  /**
   * Constructs an <code>XAQSessPrepare</code> instance.
   *
   ...
   * @param acks  Vector of <code>QSessAckRequest</code> instances.
   */
  public XAQSessPrepare(String id, Vector sendings, Vector acks)
  {
    super(null);
    this.id = id;
  ...
  /** Returns the vector of <code>QSessAckRequest</code> instances. */
