 ...
 * <p>
 */
public class UserMSF implements ManagedServiceFactory {
	public static final Logger logmon = Debug.getLogger(UserMSF.class.getName());
  ...
  public UserMSF(final BundleContext bundleContext) {
  	if (logmon.isLoggable(BasicLevel.DEBUG))
      logmon.log(BasicLevel.DEBUG, "UserMSF(" + bundleContext + ')');
    this.bundleContext = bundleContext;
    Properties props = new Properties();
    props.setProperty(Constants.SERVICE_PID, UserMSF.class.getName());
