...
public class VMWareFramework {
  ClientFramework framework = null;
  
  /**
   * Initialization of VMWare framework.
   * 
   ...
   */
  public VMWareFramework(String host, int port,
    ...
    try {
      framework = new ClientFramework("VMWare", cf);
    } catch (Exception exc) {
      Trace.fatal("VMWareFramework: Cannot initialize framework.", exc);
      throw exc;
    }
    try {
