...
public interface JoramFramework {
   ...
   * @throws JMSException 
   */
  void publishInventoryCMDB(String inventory) throws JMSException;
   ...
   * @throws JMSException 
   */
  void publishInventoryVMWare(String inventory) throws JMSException;
   ...
   * @throws JMSException
   */
  void publishParameters(Properties parameters) throws JMSException;
}
