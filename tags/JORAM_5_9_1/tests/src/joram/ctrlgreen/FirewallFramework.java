 ...
 * 
 */
public class FirewallFramework {
  ClientFramework framework = null;
  
  /**
   * Initialization of Firewall framework.
   * 
   ...
   */
  public FirewallFramework(String host, int port,
    ...
    try {
      framework = new ClientFramework("Firewall", cf);
    } catch (Exception exc) {
      Trace.fatal("FirewallFramework: Cannot initialize framework.", exc);
      throw exc;
    }
    try {
