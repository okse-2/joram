...
/**
 * Test : recover - on send - on receive and killServer/restartServer
 * 
 */
public class Test5 extends TestCase {
	...
	public void admin() throws Exception {
		...
		javax.jms.XAConnectionFactory cf = 
			org.objectweb.joram.client.jms.tcp.XATcpConnectionFactory.create("localhost", 2560);
