...
public class ClientFramework implements JoramFramework, ClientFrameworkMBean {
  ...
  @Override
  public ActionReturn invokeAction(String name,
                                   Action action) throws JMSException {
  ...
  public ActionReturn invokeAction(String name,
    ...
    ActionReturn actionReturn = getActionRequestor().request(actionQueue, name, action, timeout);
    return actionReturn;
  }

  @Override
  public void throwAction(String name, Action action) throws JMSException {
    getActionRequestor().request(actionQueue, name, action, 0);
  }
  ...
  @Override
  public void publishParameters(Parameters parameters) throws JMSException {
  ...
  @Override
  public void publishInventoryVMWare(Inventory inventory) throws JMSException {
