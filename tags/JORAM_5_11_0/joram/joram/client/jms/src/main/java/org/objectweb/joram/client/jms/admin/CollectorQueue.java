...
/**
 * The <code>CollectorQueue</code> class allows administrators to create JMS
 * collector queues.
 * <p>
 * Collector queues are special destinations usable to collect a document from
 * a specified URL. They can be used to periodically import a file from an URL to
 * a Joram's message and store it in this queue.
 */
