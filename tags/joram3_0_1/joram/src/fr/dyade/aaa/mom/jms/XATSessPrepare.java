...
/**
 * An <code>XATSessPrepare</code> instance is used by an
 * <code>XATopicSession</code> for sending messages and acknowledgements
 * to the proxy.
 */
public class XATSessPrepare extends AbstractJmsRequest
{
  ...
  /** Vector of <code>TSessAckRequest</code> instances. */
  private Vector acks;
  

  /**
   * Constructs an <code>XATSessPrepare</code> instance.
   *
   ...
   * @param acks  Vector of <code>TSessAckRequest</code> instances.
   */
  public XATSessPrepare(String id, Vector sendings, Vector acks)
  {
    super(null);
    this.id = id;
  ...
  /** Returns the vector of <code>TSessAckRequest</code> instances. */
