...
/**
 * Test: Creation of 2 bridge queues through the XML scripts.
 *  - Use JMS bridge factoriese.
 *  - Sends 10 messages to distribution queue.
 *  - Receives the messages from the acquisition queue.
 */
public class BridgeAdminTest2 extends TestCase {
  public static void main(String[] args) {
    new BridgeAdminTest2().run();
  }
