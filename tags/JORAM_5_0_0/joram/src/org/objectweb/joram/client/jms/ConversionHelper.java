...
class ConversionHelper {
   ...
   *
   * @exception MessageFormatException  If the given object can't be converted
   *              into a boolean value.
   */
  public static boolean toBoolean(Object value) throws MessageFormatException {
    if (value == null)
   ...
   *              into a byte value.
   */ 
  public static byte toByte(Object value) throws MessageFormatException {
    if (value == null)
   ...
   *              into a short value.
   */ 
  public static short toShort(Object value) throws MessageFormatException {
    if (value == null)
   ...
   *              into an int value.
   */ 
  public static int toInt(Object value) throws MessageFormatException {
    if (value == null)
   ...
   *              into a long value.
   */ 
  public static long toLong(Object value) throws MessageFormatException {
    if (value == null)
   ...
   *              into a float value.
   */
  public static float toFloat(Object value) throws MessageFormatException {
    if (value == null)
   ...
   *              into a double value.
   */ 
  public static double toDouble(Object value) throws MessageFormatException {
    if (value == null)
   ...
   *              into a char value.
   */
  public static char toChar(Object value) throws MessageFormatException {
    if (value == null)
   ...
   *              into a bytes array.
   */
  public static byte[] toBytes(Object value) throws MessageFormatException {
    if (value == null)
      return (byte[]) value;
