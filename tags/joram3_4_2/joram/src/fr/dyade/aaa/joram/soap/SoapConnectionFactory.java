 ...
 * connections.
 */
public class SoapConnectionFactory extends fr.dyade.aaa.joram.ConnectionFactory
{
  /**
  ...
  /**
   * Codes a <code>SoapConnectionFactory</code> as a vector for travelling
  ...
  /**
   * Decodes a coded <code>SoapConnectionFactory</code>.
   *
                ...
                throws NamingException
  {
    try {
      ...
      SoapConnectionFactory cnxFact =
        new SoapConnectionFactory(host, port ,timeout);
