...
/**
 * <b>AddNotificationListener1</b> is the object that is sent by a requestor who
 * wishes to appeal JMX addNotificationListener(ObjectName name,ObjectName
...
public class AddNotificationListener1 extends AddNotificationListener implements Serializable {
  ...
  public AddNotificationListener1(ObjectName name, ObjectName listener, NotificationFilter filter,
      Object handback) {
