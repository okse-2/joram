...
public class MessagePropertyTest extends PTPTestCase {
   ...
   * Float, Double</code>
   * and <code>String</code> used in the
   * <code>Message.setObjectProperty()</code> method throws a
  ...
  /**
   * if a property is set as a <code>Float</code> with the
   * <code>Message.setObjectProperty()</code> method, it can be retrieve
   * directly as a <code>double</code> by
   * <code>Message.getFloatProperty()</code>
   */
  ...
  /**
   * Test that a <code>null</code> value is returned by the
   * <code>Message.getObjectProperty()</code> method if a property by the
  ...
  /**
   * Test that a <code>null</code> value is returned by the
   * <code>Message.getStringProperty()</code> method if a property by the
   * specified name does not exits.
   */
  ...
  /**
   * Test that an attempt to get a <code>double</code> property which does not
   * exist throw a <code>java.lang.NullPointerException</code>
   */
  ...
  /**
   * Test that an attempt to get a <code>float</code> property which does not
   * exist throw a <code>java.lang.NullPointerException</code>
   */
  ...
  /**
   * Test that an attempt to get a <code>long</code> property which does not
   * exist throw a <code>java.lang.NumberFormatException</code>
   */
  ...
  /**
   * Test that an attempt to get a <code>int</code> property which does not
   * exist throw a <code>java.lang.NumberFormatException</code>
   */
  ...
  /**
   * Test that an attempt to get a <code>short</code> property which does not
   * exist throw a <code>java.lang.NumberFormatException</code>
   */
  ...
  /**
   * Test that an attempt to get a <code>byte</code> property which does not
   * exist throw a <code>java.lang.NumberFormatException</code>
   */
  ...
  /**
   * Test that an attempt to get a <code>boolean</code> property which does
   * not exist returns <code>false</code>
   */
  ...
  /**
   * Test that the <code>Message.getPropertyNames()</code> method does not
   * return the name of the JMS standard header fields (e.g.
  ...
  /**
   * Test that the <code>Message.getPropertyNames()</code> method returns an
   * empty <code>java.util.Enumeration</code> if there is no properties.
   * <br />
  ...
  /**
   * Test that the <code>Message.clearProperties()</code> method does not
   * clear the value of the Message's body.
   */
  ...
  /**
   * Test that the <code>Message.clearProperties()</code> method deletes all
