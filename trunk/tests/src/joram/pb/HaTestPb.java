...
public class HaTestPb  {
	...
	try{
	    ...
	    */
	    ...
	    javax.jms.TopicConnectionFactory tcf = TopicHATcpConnectionFactory.create("hajoram://localhost:16010,localhost:16011,localhost:16012");
	    ...
	    TopicConnection connection = tcf.createTopicConnection("root","root");
	    ...
	    for (int i=0; i<nb; i++) {
		cnx[i] = tcf.createTopicConnection("root","root");
