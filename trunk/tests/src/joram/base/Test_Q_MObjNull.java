 ...
 *     Use a null as object and a Queue as destination.
 */
public class Test_Q_MObjNull extends TestCase {
  public static void main(String[] args) {
    new Test_Q_MObjNull().run();
  }
  ...
  public void run() {
    try {
      ...
      Session session = cnx.createSession(false,
      ...
      // create a message containing null send to the queue by the pruducer 
      ...
      Object obj_receive = msg2.getObject();
