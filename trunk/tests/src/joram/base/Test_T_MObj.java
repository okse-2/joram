...
public class Test_T_MObj extends TestCase implements javax.jms.MessageListener  {
  ...
  public void run() {
    try {
      ...
      // creates connection, session, producer and consumer
      ...
      Serializable obj_send= new String("abcdef");
  ...
  public void onMessage(Message message) {
    ...
    try{
      ...
      Object obj_producer = msg_send.getObject();
      ...
      assertEquals(obj_producer, obj_consumer);
