 ...
 */
public class TestMonitoringTopic extends TestCase implements MessageListener {

  private int nbReceived;

  public static void main(String[] args) {
    new TestMonitoringTopic().run();
  }
  ...
  public void onMessage(Message message) {
    ...
    try {
      ...
      while (enumNames.hasMoreElements()) {
        ...
        assertEquals("#0.0.10", message.getObjectProperty(name));
      }
