 ...
 * by the producer Use two alias topics
 */
public class AliasTestT extends TestCase implements javax.jms.MessageListener
{
	...
	public void admin() throws Exception
	{
		...
		propAckTopic.put("acquisition.className",
				"org.objectweb.joram.mom.dest.VoidAcquisitionHandler");
		Topic tack = Topic.create(0, "tack", Topic.ACQUISITION_TOPIC,
				propAckTopic);
		...
		Topic tdist = Topic.create(0, "tdist", Topic.DISTRIBUTION_TOPIC,
				propDistTopic);
