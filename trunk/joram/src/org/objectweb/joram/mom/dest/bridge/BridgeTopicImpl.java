...
public class BridgeTopicImpl extends TopicImpl {
  ...
  private BridgeModule jmsModule;
   ...
   */
  public void bridgeDeliveryNot(AgentId from, BridgeDeliveryNot not) {
   ...
   */
  public void bridgeAckNot(BridgeAckNot not) {
