...
public class SchedulerInputStream implements NotificationInputStream {
  ...
  public static final String RCS_VERSION="@(#)$Id: SchedulerInputStream.java,v 1.1 2002-03-06 16:52:20 joram Exp $"; 
  ...
  parseLoop:
	...
	while (true) {
	  ...
	  input.nextToken();
        ...
        Debug.getMonitor("fr.dyade.aaa.task").log(BasicLevel.ERROR,
