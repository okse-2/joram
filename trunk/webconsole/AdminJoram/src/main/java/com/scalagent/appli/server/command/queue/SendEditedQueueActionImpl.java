...
public class SendEditedQueueActionImpl extends
    ActionImpl<SendEditedQueueResponse, SendEditedQueueAction, RPCServiceImpl> {

  @Override
  public SendEditedQueueResponse execute(RPCServiceImpl cache, SendEditedQueueAction sendEditedQueueAction) {
