...
public class ClearPendingMessageActionImpl extends
    ActionImpl<ClearPendingMessageResponse, ClearPendingMessageAction, RPCServiceCache> {

  @Override
  public ClearPendingMessageResponse execute(RPCServiceCache cache,
    ...
    if (!result) {
      info = BaseRPCService.getString("Error while clearing pending messages : Queue \""
