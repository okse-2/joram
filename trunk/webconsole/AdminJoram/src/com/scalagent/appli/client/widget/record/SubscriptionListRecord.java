...
public class SubscriptionListRecord extends ListGridRecord {
	...
	public void setSubscription(SubscriptionWTO sub) { this.sub = sub; }
	public void setName(String name) { setAttribute(ATTRIBUTE_NAME, name); }
	public void setActive(boolean active) { setAttribute(ATTRIBUTE_ACTIVE, active); }
	public void setDurable(boolean durable) { setAttribute(ATTRIBUTE_DURABLE, durable); }
	public void setNbMaxMsg(int nbMaxMsg) { setAttribute(ATTRIBUTE_NBMAXMSG, nbMaxMsg); }
	public void setContextId(int contextId) { setAttribute(ATTRIBUTE_CONTEXTID, contextId); }
	public void setNbMsgsDeliveredSinceCreation(int nbMsgsDeliveredSinceCreation) { setAttribute(ATTRIBUTE_NBMSGSDELIVEREDSINCECREATION, nbMsgsDeliveredSinceCreation); }
	...
	public void setSelector(String selector) { setAttribute(ATTRIBUTE_SELECTOR, selector); }
	public void setSubRequestId(int subRequestId) { setAttribute(ATTRIBUTE_SUBREQUESTID, subRequestId); }
	
	public SubscriptionWTO getSubscription() { return sub; }
	public String getName() { return getAttributeAsString(ATTRIBUTE_NAME); }
	public boolean isActive() { return getAttributeAsBoolean(ATTRIBUTE_ACTIVE); }
	public boolean isDurable() { return getAttributeAsBoolean(ATTRIBUTE_DURABLE); }
	public int getNbMaxMsg() { return getAttributeAsInt(ATTRIBUTE_NBMAXMSG); }
	public int getContextId() { return getAttributeAsInt(ATTRIBUTE_CONTEXTID); }
	public int getNbMsgsDeliveredSinceCreation() { return getAttributeAsInt(ATTRIBUTE_NBMSGSDELIVEREDSINCECREATION); }
	public int getNbMsgsSentToDMQSinceCreation() { return getAttributeAsInt(ATTRIBUTE_NBMSGSSENTTODMQSINCECREATION); }
	public int getPendingMessageCount() { return getAttributeAsInt(ATTRIBUTE_PENDINGMESSAGECOUNT); }
	public String getSelector() { return getAttributeAsString(ATTRIBUTE_SELECTOR); }
	public int getSubRequestId() { return getAttributeAsInt(ATTRIBUTE_SUBREQUESTID); }
