...
UpdateCompleteHandler
{
	...
	/**
	 * This method is called by the EventBus when a new queue has been created on the server.
	...
	/**
	 * This method is called by the QueueListWidge when the user click on the "Clear Pending Messages" button.
	 * The name of the queue is sent to the server which clears the messages for the selected queue.
	 */
	...
	/**
	 * This method is called by the QueueListWidge when the user click on the "Clear Waiting Requests" button.
	 * The name of the queue is sent to the server which clears the requests for the selected queue.
	 */
	...
	/**
	 * This method is called by the QueueListWidget when the user click on "browse" button of a queue.
	...
	/**
	 * This method is called by the QueueListWidget when the user submit the new queue form.
	...
	/**
	 * This method is called by the QueueListWidget when the user submit the edited queue form.
	 * The form information are sent to the server.
	 */
	...
	/**
	 * This method is called by the QueueListWidget when the user click the "delete" button of a queue.
