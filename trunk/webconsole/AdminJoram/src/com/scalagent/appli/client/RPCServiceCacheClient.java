...
public class RPCServiceCacheClient implements BaseRPCServiceCacheClient {
	...
	public HashMap<String, TopicWTO> getTopics() { return topics; }
	public HashMap<String, QueueWTO> getQueues() { return queues; }
	public HashMap<String, MessageWTO> getMessages() { return messages; }
	public HashMap<String, UserWTO> getUsers() { return users; }
	public HashMap<String, SubscriptionWTO> getSubscriptions() { return subs; }

	public SortedMap<Date, Integer> getTopicsHistory() { return topicsHistory; }
	public SortedMap<Date, Integer> getQueuesHistory() { return queuesHistory; }
	public SortedMap<Date, Integer> getMessagesHistory() { return messagesHistory; }
