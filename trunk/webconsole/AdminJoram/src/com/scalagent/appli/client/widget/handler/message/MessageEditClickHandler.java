...
public class MessageEditClickHandler implements ClickHandler {
	...
	public MessageEditClickHandler(QueueDetailPresenter qPresenter, DynamicForm form) {
		super();
		this.qPresenter = qPresenter;
		this.form = form;
	}
	public MessageEditClickHandler(SubscriptionDetailPresenter sPresenter, DynamicForm form) {
		super();
	...
	public void onClick(ClickEvent event) {
		try {
			if(form.validate())
			{
				...
				if(qPresenter != null) qPresenter.editMessage(newMessage, queueNameValue);
				else sPresenter.editMessage(newMessage, queueNameValue);
			}  
		} catch (Exception e) {
