...
if ($MESSAGE eq "") {
  ...
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram_src_jar.zip\">Joram PC : sources and jar</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram_jar.zip\">Joram PC : jar</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram_src_jar.tar.gz\">Joram Unix : sources and jar</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram_jar.tar.gz\">Joram Unix : jar</a></li>\n";
  print "</ol>\n";
