...
if ($MESSAGE eq "") {
  ...
  print "<li>JORAM 2.2\n";
  print "<ol>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.2-src.tar.gz\">sources (tar.gz file)</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.2-src.zip\">sources (zip file)</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.2-bin.tar.gz\">jars (tar.gz file)</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.2-bin.zip\">jars (zip file)</a></li>\n";
  print "</ol>\n";
  print "</li><li>JORAM 2.1.1\n";
  print "<ol>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.1.1-src.tar.gz\">sources (tar.gz file)</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.1.1-src.zip\">sources (zip file)</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.1.1-bin.tar.gz\">jars (tar.gz file)</a></li>\n";
  print "<li><a HREF=\"http://www.objectweb.org/joram/download/joram-2.1.1-bin.zip\">jars (zip file)</a></li>\n";
  print "</ol>\n";
  print "</li>\n";
  print "</ul>";
