...
public class SessionTest extends PTPTestCase {
   ...
   * <strong>transacted</strong> <code>Session</code> rollbacks all the
  ...
  /**
   * Test that the <code>getTransacted()</code> method of a
   * <code>Session</code> returns <code>true</code> if the session is
   * transacted, <code>false</code> else.
   */
  public void testGetTransacted() {
    try {
      ...
      senderSession = senderConnection.createQueueSession(true,
   ...
   * message from a closed session must throw an
  ...
  /**
   * Test that it is valid to use message objects created or received via the
   * [closed] session with the exception of a received message
   * <code>acknowledge()</code> method.
   */
  ...
  /**
   * Test that closing a closed session does <strong>not</strong> throw an
   * exception.
   */
