...
/**
 * Tests receive the history of the JORAM svn using the CollectorTopic.
 */
public class TestCollectorTopic1 extends TestCase implements MessageListener {

  private int nbReceived;

  public static void main(String[] args) {
    new TestCollectorTopic1().run();
  }
  ...
  public void admin() throws Exception {
    ...
    // create a Topic   
    Topic topic = CollectorTopic.create(0, "CollectorTopic", url, properties);
