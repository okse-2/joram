...
/**
 * Test : send message to the server; kill the server; restart the server. The
 * server restores messages, and then the receiver can receive it. Use a Queue
 */
public class Recover_1 extends TestCase {
  ...
  public void connect() {
    try {
      ...
      sessionc = cnx.createSession(false, Session.AUTO_ACKNOWLEDGE);
      cnx.start();
  ...
  public void admin() throws Exception {
    ...
    // create a Queue   
    org.objectweb.joram.client.jms.Queue queue = (org.objectweb.joram.client.jms.Queue) org.objectweb.joram.client.jms.Queue
        .create("queue");
