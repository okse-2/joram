...
/**
 * Configure a producer and a consumer on 2 queues of the cluster, verify that each message sent
 * on a queue is received through this queue. Test that no message is delivered on the third queue.
 */
public class TestQ1 extends TestQBase {
  ...
  public void run() {
    try {
      ...
      prop.setProperty("producThreshold", "51");
      ...
      assertEquals(i, listener0.nbMsg);
      assertEquals(i, listener1.nbMsg);
