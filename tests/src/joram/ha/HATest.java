...
public class HATest extends TestCase {
  ...
  public void run() {
    ...
    try {
      ...
      ConnectionFactory cf = org.objectweb.joram.client.jms.ha.tcp.HATcpConnectionFactory
  ...
  public static Process startAgentServer(short sid, File dir, String[] jvmarg,
    ...
    return startAgentServer(sid, dir, jvmarg, servarg,
        "fr.dyade.aaa.agent.AgentServer");
  }

  public static Process startAgentServer(short sid, File dir, String[] jvmarg,
      String[] servarg, String serverClassName) throws Exception {
    String javapath = new File(
