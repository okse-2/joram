 ...
 */
public class ClearWaintingRequestClickHandler implements ClickHandler {

  private QueueListPresenter queuePresenter;
  private QueueListRecord record;

  public ClearWaintingRequestClickHandler(QueueListPresenter queuePresenter, QueueListRecord record) {
    super();
  ...
  public void onClick(ClickEvent event) {
    ...
    queuePresenter.clearWaintingRequest(record.getQueue());
  }
}
