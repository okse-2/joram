...
public class TestQ4 extends TestCase {
	...
	try {
	    ...
	    MsgListenerCluster4 listener0 =new MsgListenerCluster4("recv0 ");
	    MsgListenerCluster4 listener1 =new MsgListenerCluster4 ("recv1 ");
	    ...
	    MessageProducer producer0 = sess.createProducer(null);
		...
		producer0.send(clusterQueue, msg);
	...
	prop.setProperty("producThreshold","2");
	prop.setProperty("consumThreshold","3");
...
class MsgListenerCluster4 implements MessageListener
{
    String ident = null;
    public int nbMsg;

    public MsgListenerCluster4() {}
    
    public MsgListenerCluster4(String ident) {
	nbMsg=0;
	this.ident = ident;
    }
	...
	nbMsg++;
	try{
	Thread.sleep(500); // queue store message and producThreshold active
	}catch(Exception exc){}
	System.out.println(ident+" eee");
    }
}
