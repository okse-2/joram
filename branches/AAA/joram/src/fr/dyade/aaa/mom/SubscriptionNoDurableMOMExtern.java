 ...
 *	nevertheless this subscription is not persistent, that means
 *	tha it disappears when application stops 
 * 
 *	@see fr.dyade.aaa.mom.CommonClient
 */ 
 
public class SubscriptionNoDurableMOMExtern extends MessageMOMExtern { 
