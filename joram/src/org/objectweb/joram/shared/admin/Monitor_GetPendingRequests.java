 ...
 */
public class Monitor_GetPendingRequests extends Monitor_Request {
  private static final long serialVersionUID = 8340209566338532807L;
   ...
   */
  public Monitor_GetPendingRequests(String dest) {
    this.dest = dest;
  }
