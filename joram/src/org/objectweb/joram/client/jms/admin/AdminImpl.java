...
public class AdminImpl implements AdminItf
{
  ...
  String getDestinationName(javax.jms.Destination dest)
  {
    ...
    if (! className.equals("org.objectweb.joram.client.jms.Queue")
        && ! className.equals("org.objectweb.joram.client.jms.Topic")
        && ! className.equals("org.objectweb.joram.client.jms.DeadMQueue")) {
