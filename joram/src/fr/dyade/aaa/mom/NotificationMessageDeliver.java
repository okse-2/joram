...
public class NotificationMessageDeliver extends fr.dyade.aaa.mom.NotificationMOMRequest { 
 
	/** message received by a agentClient from a Queue or a Topic */ 
	public fr.dyade.aaa.mom.Message msg ;

	public NotificationMessageDeliver(long messageID, fr.dyade.aaa.mom.Message msgNew) { 
		super(messageID);
		msg = msgNew; 
	} 
