...
/** 
 *	a Selector Object allows to filter messages 
 * 
...
public class Selector implements java.io.Serializable  { 
	...
	public boolean isAvailable(fr.dyade.aaa.mom.Message msg, String selector) throws Exception {
		/* don't forget to test if selector==null */
		if(selector==null)
			return true;
