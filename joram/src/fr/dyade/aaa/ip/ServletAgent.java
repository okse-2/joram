...
public abstract class ServletAgent extends Agent {
  ...
  public static final String RCS_VERSION="@(#)$Id: ServletAgent.java,v 1.1 2002-03-06 16:55:06 joram Exp $"; 
  ...
  protected String getLogTopic() {
    return Debug.A3Proxy + ".ServletAgent." + getClass().getName();
  }
  ...
  class Monitor extends Daemon {
    ...
    protected Monitor(String name, int id,
                      org.objectweb.monolog.api.Monitor logmon) {
      super(name);
      this.id = id;
      this.logmon = logmon;
    }
