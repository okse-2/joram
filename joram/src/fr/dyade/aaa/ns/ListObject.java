 ...
 * The <code>NameService</code> agent replies with a <code>ListReportObject</code>
 * notification sent to the agent referenced in <code>report</code>.
 *
 * @author	Nicolas Tachker
 * @version	v1.0
 *
 * @see		ListReportObject
 */
public class ListObject extends SimpleCommand {

public static final String RCS_VERSION="@(#)$Id: ListObject.java,v 1.12 2004-02-13 08:14:35 fmaistre Exp $";
   ...
   */
  public ListObject(AgentId report, String name) {
    super(report, name);
  }
}
